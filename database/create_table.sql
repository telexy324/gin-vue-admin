...
(
    ...
    `start_server_name`     varchar(100) NOT NULL DEFAULT '' COMMENT '源节点名称',
    `start_server_position` tinyint(2) NOT NULL DEFAULT '0' COMMENT '源节点是否系统外 0 系统外, 1 系统内',
    `end_server_id`         bigint UNSIGNED NOT NULL DEFAULT '0' COMMENT '目的节点id',
    `end_server_name`       varchar(100) NOT NULL DEFAULT '' COMMENT '目的节点名称',
    `end_server_position`   tinyint(2) NOT NULL DEFAULT '0' COMMENT '目的节点是否系统外 0 系统外, 1 系统内',
    `end_server_ip`         varchar(15)  NOT NULL DEFAULT '' COMMENT '目的节点ip',
    `end_server_port`       int(5) NOT NULL DEFAULT '0' COMMENT '目的节点端口',
