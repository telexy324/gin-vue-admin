...
var doc = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/scheduleMdl.Schedule"
                        }
                    }
                ],
                "responses": {
        ...
        "/task/schedule/deleteScheduleByIds": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/task/schedule/getTemplateScheduleList": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
        ...
        "/task/schedule/validateScheduleFormat": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.AddSet"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/taskMdl.TaskTemplate"
                        }
                    }
                ],
                "responses": {
        ...
        "/task/template/deleteTemplateByIds": {
            "post": {
                "security": [
                    {
                        "ApiKeyAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/request.ProcessTaskRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "config.Task": {
            ...
            "properties": {
                "max_parallel_tasks": {
                    "description": "AccessKeyEncryption string ` + "`" + `mapstructure:\"access_key_encryption\" json:\"access_key_encryption\" yaml:\"access_key_encryption\"` + "`" + `\ntask concurrency",
                    "type": "integer"
                },
                "tmp_path": {
                    "type": "string"
        ...
        "request.AddSet": {
            ...
            "properties": {
                ...
                "templates": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/taskMdl.TaskTemplateSetTemplate"
                    }
                },
                "updatedAt": {
                    "description": "更新时间",
