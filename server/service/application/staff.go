...
func (staffService *StaffService) AddAdmin(admin application.Admin) error {
...
func (staffService *StaffService) DeleteAdmin(id float64) (err error) {
...
func (staffService *StaffService) UpdateAdmin(admin application.Admin) (err error) {
...
func (staffService *StaffService) GetAdminById(id float64) (err error, admin application.Admin) {
...
func (staffService *StaffService) GetAdminList(info request2.AdminSearch) (err error, list interface{}, total int64) {
	limit := info.PageSize
...
func (staffService *StaffService) GetDepartmentAll() (err error, departmentList []application.Department) {
