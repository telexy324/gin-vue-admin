              ...
              <CardContent className="px-0 pb-0">
                <form className="space-y-4" onSubmit={onSubmit}>
                  ...
                  <div className="grid grid-cols-2 gap-3 pt-1">
                    <Button type="button" variant="outline" className="h-11 border-white/20 bg-transparent text-white hover:bg-white/10" onClick={goInit}>
                      前往初始化
                    </Button>
                    <Button type="submit" className="h-11 bg-cyan-500 text-slate-950 hover:bg-cyan-400" disabled={submitting}>
                      {submitting ? '登录中...' : '登录'}
                    </Button>
                  </div>
                </form>
